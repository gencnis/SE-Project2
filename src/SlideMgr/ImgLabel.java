...
//This is used for Image importing. Stores a reference of the image for resizing in resources folder if needed.(not implemented)
public class ImgLabel extends JLabel implements java.io.Serializable
{
    ...
    public ImgLabel(Icon i, Slide s)
    {
       ...
       // ComponentResizer cr = new ComponentResizer();     //resizing does not work this way
        //cr.registerComponent(this);
        ComponentMover cm = new ComponentMover();   //allows dragging
